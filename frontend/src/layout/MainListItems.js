...
const MainListItems = ({ collapsed, drawerClose }) => {
  ...
  return (
    <div onClick={drawerClose}>
      ...
      <ListItemLink to="/" primary="Tablero" />

            <Tooltip title={collapsed ? i18n.t("Dashboard") : ""} placement="right">
              <ListItem
                dense
                button
...
*/}
            ...
            yes={() => (
              user.profile === "admin" && (
                <ListItemLink to="/" primary="Automatización" />
              )
            )}
          />
      ...
      <ListItemLink to="/" primary="Configuraciones" />
