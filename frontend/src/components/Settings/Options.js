...
export default function Options(props) {
  ...
  // Cerrar ticket ao transferir para outro setor
  ...
  const [transferMessage, setTransferMessage] = useState("Su servicio ha sido transferido al departamento ${queue.name}. Espere asistencia...");
