...
const FlowBuilderAddQuestionModal = ({
  ...
  const [labels, setLabels] = useState({
    title: "Agregar pregunta al flujobot",
    btn: "Agregar",
  });
  ...
  useEffect(() => {
    if (open === "edit") {
      setLabels({
        title: "Editar pregunta de flujobot",
        btn: "Guardar",
      });
      ...
      setLabels({
        title: "Crear pregunta en el flujobot",
        btn: "Guardar",
      });
    ...
    <div className={classes.root}>
      ...
      >
        <DialogTitle id="form-dialog-title">
          {open === "create" ? `Agregar pregunta al flujobot` : `Editar pregunta`}
        </DialogTitle>
        <Formik
