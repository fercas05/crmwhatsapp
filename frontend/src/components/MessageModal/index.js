          ...
          {({ touched, errors, isSubmitting, values }) => (
            <Form>
              <DialogContent dividers>
                ...
                <h3>Recorrencia</h3>
                <p>
                  Puede optar por enviar el mensaje de forma recurrente y
                  elige el rango. Si es un mensaje para enviar
                  una vez, no cambie nada en esta sección.
                </p>
                <br />
                <Grid container spacing={1}>
                  <Grid item xs={12} md={4} xl={4}>
                  ...
                  <Grid item xs={12} md={12} xl={12}>
                  <FormControl size="small" fullWidth variant="outlined">
                      <InputLabel id="demo-simple-select-label">Enviar tantas veces</InputLabel>
                      <Select
                        labelId="demo-simple-select-label"
                        id="demo-simple-select"
                      ...
                      >
                        <MenuItem value={4}>Enviar normalmente en días no laborables</MenuItem>
                      <MenuItem value={5}>Enviar con un día hábil de anticipación</MenuItem>
                ...
                {scheduleMessage?.file?.name && (
                  <>
                    <div>
                      <h4>Archivo adjunto: {scheduleMessage?.file?.name}</h4>
                    </div>
                  </>
                )}
              </DialogContent>
