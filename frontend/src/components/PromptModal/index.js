...
const PromptSchema = Yup.object().shape({
    ...
    prompt: Yup.string().min(50, "¡Demasiado corto!").required("Describir la formación en Inteligencia Artificial"),
    voice: Yup.string().required("Ingrese al modo de voz"),
    max_tokens: Yup.number().required("Ingrese el número máximo de tokens"),
    temperature: Yup.number().required("Ingrese la temperatura"),
    apikey: Yup.string().required("Ingrese una API Key"),
    queueId: Yup.number().required("Ingrese un departamento"),
