...
const QueueSchema = Yup.object().shape({
  options: Yup.array()
    .of(
      Yup.object().shape({
        name: Yup.string().min(4, "demasiado corto").required("Requerido"),
      })
    )
    .required("Debe tener amigos"),
});
...
export default function VerticalLinearStepper(props) {
  ...
  const handleSaveBot = async (values) => {
    try {
      ...
      toast.success("Bot guardado exitosamente");
      // setActiveStep(-1)
  ...
  const handleDeleteQueue = async (queueId) => {
    try {
      ...
      setGreetingMessageEdit(null);
      setSteps(data);
      toast.success(i18n.t("¡Cola eliminada exitosamente!"));
    } catch (err) {
      toastError(err);
    }
    setSelectedQueue(null);
                                  ...
                                  <Grid xs={12} md={8} item>
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        <MenuItem value={"queue"}>Cola</MenuItem>
                              ...
                              <StepContent>
                                <>
                                  <CustomToolTip
                                    ...
                                    content="Si el mensaje no está definido, el bot no avanzará"
                                  >
