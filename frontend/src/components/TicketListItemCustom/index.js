                        ...
                        <span className={classes.contactNameWrapper}>
                            ...
                            >
                                ...
                                <span className={classes.secondaryContentSecond} >
                                    ...
                                    {<Badge style={{ backgroundColor: ticket.queue?.color || "#7c7c7c" }} className={classes.connectionTag}>{ticket.queueId ? ticket.queue?.name.toUpperCase() : ticket.status === "lgpd" ? "LGPD" : "SIN DEPARTAMENTO"}</Badge>}
