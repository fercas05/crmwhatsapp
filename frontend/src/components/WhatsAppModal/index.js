            ...
            <Form>
              <Paper className={classes.mainPaper} elevation={1}>
                ...
                >
                  ...
                  <Tab label="Flujo estándar" value={"flowbuilder"} />
              ...
              <Paper className={classes.paper} elevation={0}>
                ...
                {showIntegrations && (
                  <>
                    ...
                    >
                      <DialogContent>
                        <h3>Flujo de bienvenida</h3>
                        <p>Este flujo solo se activa para contactos nuevos, personas que no tienes en tu lista de contactos y que han enviado un mensaje.
                        </p>
                        <FormControl
                          variant="outlined"
                          margin="dense"
                      ...
                      <DialogContent>
                        <h3>Flujo de respuesta predeterminado</h3>
                        <p>La respuesta estándar se envía con cualquier carácter que no sea una palabra clave. ¡ATENCIÓN! Se activará si el servicio ya está cerrado.
                        ...
                        >
                          <Select
                            ...
                            <MenuItem value={null} >{"Desactivado"}</MenuItem>
                            {webhooks.map(webhook => (
                              <MenuItem key={webhook.id} value={webhook.id}>
                                {webhook.name}
                              </MenuItem>
