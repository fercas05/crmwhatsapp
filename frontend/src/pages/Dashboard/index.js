...
const Dashboard = () => {
  ...
  const exportarGridParaExcel = () => {
    ...
    XLSX.writeFile(wb, 'informe_del_agente.xlsx');
  };
                ...
                <Grid2 container spacing={3} className={classes.container}>
                        ...
                        <Grid2 xs={12} sm={6} md={3}>
                          <Paper elevation={3} >
                            <ChartDonut
                              ...
                              `{'name': 'Detractores', 'value': ${counters.npsDetractorsPerc | 0}}`,
                              `{'name': 'Neutrales', 'value': ${counters.npsPassivePerc | 0}}`
                              ]}
                  ...
                  >
                    <Container width="100%" className={classes.container}>
                      ...
                      <IconButton onClick={exportarGridParaExcel} aria-label="Exportar Excel">
                        <SaveAlt />
                      </IconButton>
