        ...
        >
          ...
          <div>
            <TextField
              ...
              // defaultValue={`Su licencia vence en ${returnDays(user?.company?.dueDate)} dias!`}
              defaultValue={returnDays(user?.company?.dueDate) === 0 ? `¡Su licencia vence hoy!` : `Su licencia vence en ${returnDays(user?.company?.dueDate)} dias!`}
              fullWidth
              margin="normal"
