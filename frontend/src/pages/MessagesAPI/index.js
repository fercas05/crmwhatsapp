      ...
      <Grid container>
        <Grid item xs={12} sm={6}>
          <Typography className={classes.elementMargin} component="div">
            ...
            <b>Body: </b> {"{"} <br></br>
             "number": "001234567890" <br></br>
             "body": "Mensaje" <br></br> 
             "userId": ID de usuario o "" <br></br>
             "queueId": ID de departamento o ""<br></br>
             "sendSignature": Firmar el mensaje - true/false <br></br>
             "closeTicket": cerrar el chat - true/false<br></br>
             {"}"} 
          </Typography>
        </Grid>
        <Grid item xs={12} sm={6}>
        ...
        <Grid item xs={12} sm={6}>
          <Typography className={classes.elementMargin} component="div">
            ...
            <ul>
              ...
              <li>
                <b>sendSignature:</b> Firmar mensaje verdadero/false
              </li>
              <li>
                <b>closeTicket:</b> Cerrar chat true/false
              </li>
            </ul>
          </Typography>
        </Grid>
