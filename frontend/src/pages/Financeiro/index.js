                ...
                <TableRow style={rowStyle(invoices)} key={invoices.id}>
                  ...
                  <TableCell align="center">
                      ...
                      <Button
                        ...
                        variant="outlined"
                        color="#7946d1"
                        onClick={() => window.open(`https://wa.me/${process.env.REACT_APP_NUMBER_SUPPORT}?text=Hola%20quiero%20pagar%20mi%20plan%20mi%20facturacion%20esta%20a%20nombre%20de%20ID(${invoices.id})`)}
                      >
