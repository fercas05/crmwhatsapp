const messages = {
  tr: {
    translations: {
      ...
      initialConfig: {
        title: "İlk ayar",
        content1: "CRMwhatsapp 😊'a Hoşgeldiniz",
        content2:
          "Bunu kolaylaştırmak için * Hayatın, otomatik bir başlangıç ​​konfigürasyonu sağlıyoruz, böylece tüm CRMwhatsapp * * İnanılmaz * özelliklerini birkaç dakika içinde test edebilirsiniz.",
        content3:
        ...
        content4:
          "Bağlı sayıda ilk mesajı alır almaz, CRMwhatsapp eyleme geçecektir. 😎",
        content5:
